...
![image](https://github.com/user-attachments/assets/58594b1f-d831-4c7e-85ed-df39e4bbc86f)

![image](https://github.com/user-attachments/assets/8d5db5da-41d8-45e0-8d36-d73d49406258)

### Result:
The Python program successfully performed web scraping on Snapdeal using the BeautifulSoup library. It retrieved product details such as name, price, and rating based on the user's search query. The scraped data was sorted and visualized using a horizontal bar chart to represent product prices. This exercise demonstrated the key steps in web scraping: loading and parsing HTML content, extracting relevant data, transforming it, and presenting it effectively through data visualization. The result shows how web scraping can be used to gather real-time data from e-commerce platforms efficiently.
